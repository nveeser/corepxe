...
func (c *collect) Object(n Node, v map[string]any) Result { return c.collect(n.Path) }
func (c *collect) Sequence(n Node, v []any) Result        { return c.collect(n.Path) }
func (c *collect) Scalar(n Node, v any) Result            { return c.collect(n.Path) }
